  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button 
          variant="ghost" 
          className="flex items-center gap-1 sm:gap-2 md:gap-3 px-1.5 sm:px-2 md:px-3 py-1.5 sm:py-2 h-auto hover:bg-gray-100 dark:hover:bg-zinc-800"
        >
          ...
          <ChevronDown className="hidden sm:block h-3.5 w-3.5 sm:h-4 sm:w-4 text-gray-500 dark:text-zinc-400" />
        </Button>
      </DropdownMenuTrigger>
